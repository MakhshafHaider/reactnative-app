  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.containerContent}>
          <View style={styles.helpContainer}>
            <TouchableOpacity
              ...
              <View style={styles.centeredContainer}>
                <Text style={{color: '#1583D8'}}>Dispute Resolution</Text>
          ...
          <View style={styles.helpContainer}>
            <TouchableOpacity
              onPress={() =>
                props.navigation.navigate('ConsumerProfileStack', {
                  screen: 'ConsumerWhyCancel',
                })
              }>
              <View style={styles.centeredContainer}>
                <Text style={{color: '#1583D8'}}>Order Cancellation</Text>
        ...
        <View>
          <Text style={{marginHorizontal: widthToDp(4), marginBottom: 5}}>
            FAQs
          </Text>
