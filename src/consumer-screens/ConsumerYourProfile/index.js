...
const handleAddToCart = ()=>{
  ...
  if (selectedItems > 0) {
    ...
    setButtonText(`${selectedItems}                     View Your Cart         Rs. ${totalCost}`);
    props.navigation.navigate("ConsumerHomeStack", {screen: "ConsumerAddToCart"})
      ...
      <Modal
        ...
        <View style={styles.modalContent}>
          <View style={styles.modalContainer}>
            <TouchableOpacity onPress={() => handleSelect('basic')}>
              <LinearGradient
                colors={
                  selected === 'basic'
                    ? ['#696969', '#AEAEAE']
            ...
            <TouchableOpacity onPress={() => handleSelect('premium')}>
              <LinearGradient
                colors={
                  selected === 'premium'
                    ? ['#696969', '#AEAEAE']
                ...
                style={styles.childMood}>
                <View style={{padding: 20}}>
                  <Image source={host} style={{width: 30, height: 30}} />
                  <Text style={{color: 'white', lineHeight: 20}}>
...
const styles = StyleSheet.create({
  ...
  modalContent: {backgroundColor: 'white', paddingVertical: 20},
  modalContainer: {
    flexDirection: 'row',
  ...
  childMood: {borderRadius: 10, width: width * 0.4},
  artistName: {
