    ...
    <SafeAreaView style={GLOBAL_STYLES.containerHome}>
      <ScrollView
        ...
        <View style={styles.balanceContainer}>
          ...
          <View style={styles.alignRow}>
            <Text style={styles.subHeading}>GST (13%)</Text>
            <Text style={styles.subHeading}>Rs 800</Text>
          </View>
          <View style={styles.alignRow}>
            <Text style={[styles.heading, {color: '#84668C'}]}>TOTAL</Text>
            <Text style={{color: '#84668C', fontSize: 24, fontWeight: '700'}}>
              Rs 12,300
            </Text>
          </View>
        </View>
        ...
        <View style={styles.balanceContainer}>
          <View style={styles.SwitchContent}>
            <Text style={styles.warning}>{'Cash'}</Text>
          ...
          <View style={[styles.SwitchContent, {marginTop: 10}]}>
            <Text style={styles.warning}>{'Kayanchi Wallet'}</Text>
            <Text style={{color: '#668C6A', fontWeight: '700'}}>RS 5000</Text>
            <View style={styles.switchContainer}>
              <Switch
                value={isPrivate}
                onValueChange={handlePrivate}
...
const styles = StyleSheet.create({
  ...
  subHeading: {fontSize: 16, color: '#67718C'},
  txt: {
    color: '#1583D8',
    borderColor: '#1583D8',
    borderWidth: 1,
