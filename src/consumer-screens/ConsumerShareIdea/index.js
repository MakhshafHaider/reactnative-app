...
export default function ConsumerShareIdea(props) {
  ...
  const firstRowOptions = PAYMENTS.slice(0, 2);
  const secondRowOptions = PAYMENTS.slice(2, 4);
  const thirdRowOptions = PAYMENTS.slice(4);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.files}>
        ...
        <Text style={{paddingHorizontal: 5}}>Attach a file</Text>
