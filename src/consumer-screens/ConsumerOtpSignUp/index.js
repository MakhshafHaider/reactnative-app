...
const ConsumerOtpSignUp = props => {
  ...
  const phoneSignup = async () => {
    try {
      ...
      // });
      navigation.navigate('ConsumerPasswordSignUp', {number});
      ...
      if (res.status == 200) {
        ...
        //   type: 'success',
        // });
        navigation.navigate('ConsumerPasswordSignUp', {phone_number});
      } else {
        showMessage({
          message: res.data,
          type: 'danger',
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomTxtView}>
        ...
        <Text style={styles.bottomTxt}>
          <Text style={{color: theme.linkTxt}}>{''}I didn't receive the code. Resend</Text>{' '}
