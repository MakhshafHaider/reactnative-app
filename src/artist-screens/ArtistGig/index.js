...
import {useTheme, images} from '../../utils/theme';
...
const ModalData = [
  ...
  },
  {
    ...
    modalDescription:
      'Promotional are a mix of your gigs and any additional service you want to offer',
...
export default function ArtistGig(props) {
  ...
  const handleContinueClick = () => {
    ...
    } else if (selectedContainer === 'promo') {  props.navigation.navigate('ArtistHomeStack', {
...
const styles = StyleSheet.create({
  ...
  heading: {fontSize: 40, fontWeight: 'bold', paddingVertical: heightToDp(3)},
