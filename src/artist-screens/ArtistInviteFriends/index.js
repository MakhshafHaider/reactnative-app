...
export default function ArtistInviteFriends({navigation}) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        <Text style={styles.heading}>Bring a friend &</Text>
        <Text style={styles.subheading}>
          Get <Text style={{fontWeight: 'bold'}}>15% off</Text> on your next
          order
        </Text>
        <Text style={styles.subheading}>
          Your friend gets <Text style={{fontWeight: 'bold'}}>10% off</Text> on
          their first order
        </Text>
