    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.locationContainer}>
          <View>
            <Text style={{color: '#1583D8'}}>
              3.5kms <Text style={{color: '#67718C'}}>away from you</Text>
            </Text>
            <Text style={{color: '#84668C', fontWeight: '700'}}>
        ...
        <View style={styles.circularbar}>
          ...
          <CircularProgressBar
            ...
            strokeWidth={3}
            color="#84668C"
            textStyle={{fontSize: 20, fontWeight: 'bold', fill: '#29AAE2'}}
          />
        </View>
        ...
        <View style={styles.orderContainer}>
          <View>
            <Text style={{color: '#2F3A58', fontSize: 20, fontWeight: '700'}}>
              2x Haircut
            </Text>
            <Text style={{color: '#2F3A58', fontSize: 20, fontWeight: '700'}}>
              3x Haircolor
        ...
        <View style={styles.bookingNotes}>
          <Text style={{color: '#67718C', fontWeight: '700'}}>
            BOOKING NOTES:
          </Text>
          <Text style={{color: '#67718C'}}>
